...
<p align="center">
  ...
  Built with 💻 Node.js, ⚛️ React, 🧩 Prisma & ⚙️ Express.js
</p>
...
| 🎖️ **Achievements** | Unlock badges & milestones |
...
- ⚙️ TanStack Query for API Caching  
...
|-------------|----------|----------|
| 🟢 Node.js | 18+ | Runtime |
| ⚙️ Express.js | 4.18.2 | Web Framework |
| 🔗 Prisma | 5.6.0 | ORM |
...
We ❤️ contributions from developers of all levels!
